...
public final class Constants {
    ...
    public static final String STEP_IMPORT_GENERATE_THUMBNAILS = "toybox-import-generate-thumbnails";
    public static final String STEP_IMPORT_GENERATE_ASSET = "toybox-import-generate-asset";
