...
public interface InternalSharesRepository extends JpaRepository<InternalShare, String> {
    ...
    @Transactional
    @Modifying
    @Query(value = "INSERT INTO internal_shares(internal_share_id, username, expiration_date, notify_on_edit, notify_on_download, notify_on_share, notify_on_move_or_copy, can_edit, can_download, can_share, can_move_or_copy) VALUES (:internal_share_id, :username, :expiration_date, :notify_on_edit, :notify_on_download, :notify_on_share, :notify_on_move_or_copy, :can_edit, :can_download, :can_share, :can_move_or_copy)", nativeQuery = true)
    int insertExternalShare(@Param("internal_share_id") String internalShareId, @Param("username") String username, @Param("expiration_date") Date expirationDate,
                            ...
                            @Param("notify_on_move_or_copy") String notifyOnMoveOrCopy,
